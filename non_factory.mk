...
U_BOOT_DIR = $(MAIN_TOPDIR)/third_party/u-boot-2020.01
...
ifeq ($(CONFIG_OHOS), y)
	LIBS += -lcmsis -lhichainsdk -lhos_kv_store -lhos_native_file -liothardware -lkitframework -lnetcfgservice -lota -lposix -ltoken_static -lwifiaware -lwifiservice  -lhilinkadapter_3861 -lnetcfgdevicesdk -lnetcfgota -loem_auth_config -loem_auth_result_storage
...
prepare:
	...
	if [ ! -d $(MAIN_TOPDIR)/third_party/u-boot-2020.01/u-boot-2020.01/ ]; \
	then \
	cd $(THIRD_DIR)/u-boot-2020.01; \
	tar -xvf u-boot-2020.01.tar.bz2; \
	cd $(U_BOOT_DIR)/u-boot-2020.01; \
...
all_clean:
	...
	$(RM) $(MAIN_TOPDIR)/build/libs/factory_bin
	$(RM) $(MAIN_TOPDIR)/build/scripts/__pycache__/
	$(RM) $(MAIN_TOPDIR)/third_party/u-boot-2020.01/u-boot-2020.01

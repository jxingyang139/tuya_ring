...
class ImageBuild:
    def __init__(self, app_name="Hi3861_demo", sign_alg=0x3F, kernel_file_ver=0, flashboot_file_ver=0, chip_product="Hi3861", usr_realtive_output='', ota_mode=0):
        ...
        self.__bootBinPath = os.path.join(root_path, usr_realtive_output, 'build_tmp', 'out', 'flashboot', 'signed', 'Hi3861_flash_boot.bin')
...
if __name__ == '__main__':
    ...
    if args >= 6 and sys.argv[1] in list:
        ...
        dual_ota_flag = 0 # default:compress ota
        chip_product = sys.argv[2]

...
#ifdef CONFIG_DMA_SUPPORT
    /* 濡傛灉闇�瑕佷娇鐢║ART/SPI鐨凞MA鍔熻兘锛屾垨鑰呬娇鐢↖2S椹卞姩绛夛紝闇�瑕佸垵濮嬪寲DMA */
...
{
    printf("hichannel 2021-10-27 18:00:00\n");
...
hi_void app_main(hi_void)
{
    ...
    /* 榛樿璁板綍瀹曟満淇℃伅鍒癋LASH锛屾牴鎹簲鐢ㄥ満鏅紝鍙笉璁板綍锛岄伩鍏嶉绻佸紓甯稿畷鏈烘儏鍐垫崯鑰桭LASH瀵垮懡 */
    ...
    /* 濡傛灉涓嶉渶瑕佷娇鐢℉istudio鏌ョ湅WIFI椹卞姩杩愯鏃ュ織绛夛紝鏃犻渶鍒濆鍖杁iag */

...
#define RPL_ROUTE_SYNC 5      /* Route sync */
#ifndef RPL_MBR_ROUTE_INTERFACE
#define RPL_MBR_ROUTE_INTERFACE "wlan0"
#endif

#define RPL_INSTID_NA 0xff

/* the mnid is obsolete, the value is just indicating the role of mesh */
#define RPL_MG_DEFAULT_MNID 10
 ...
 */
#define RIPPLE_STATIC_ASSERT(e) \
  ;enum { ASSERT_CONCAT(assert_line_, __LINE__) = 1 / (int)(!!(e)) }
#endif /* RIPPLE_STATIC_ASSERT */

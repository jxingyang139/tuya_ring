...
typedef enum {
  ...
  /*
   * When: New Node routing entry is added or removed or updated.
   * OnReturn: NA
   * Parameter: rpl_routeinfo_t
   */
  RPL_EVT_NODE_ROUTE_ADD,
  RPL_EVT_NODE_ROUTE_DEL,
  RPL_EVT_NODE_ROUTE_UPDATE,
  RPL_EVT_NODE_NAT64_ADD,
  RPL_EVT_NODE_NAT64_DEL,
  RPL_EVT_NODE_NAT64_UPDATE,
  /*
 ...
 * @return OK/FAIL
 */
void rpl_event_indicate(uint16_t evt, inst_t inst_id, void *arg);

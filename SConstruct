...
if scons_utils.scons_usr_bool_option('CONFIG_TARGET_CHIP_HI3861') == 'y':
    if scons_utils.scons_usr_bool_option('CONFIG_DIAG_SUPPORT') == 'y':
        ...
        elif scons_utils.scons_usr_bool_option('CONFIG_QUICK_SEND_MODE') == 'y' and scons_utils.scons_usr_bool_option('CONFIG_MGMT_FRAME_SIZE_1500') == 'y':
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861', 'debug', 'no_mesh_quick_start_mgmt_size_1500'))
        ...
        elif scons_utils.scons_usr_bool_option('CONFIG_MESH_SUPPORT') == 'y' and scons_utils.scons_usr_bool_option('CONFIG_MGMT_FRAME_SIZE_1500') == 'y':
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861', 'debug', 'mesh_mgmt_size_1500'))
        ...
        elif scons_utils.scons_usr_bool_option('CONFIG_MGMT_FRAME_SIZE_1500') == 'y':
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861', 'debug', 'no_mesh_mgmt_size_1500'))
        else:
        ...
        if factory_mode == 'yes':
            ...
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861', 'release', 'no_mesh_quick_start_mgmt_size_1500'))
        elif scons_utils.scons_usr_bool_option('CONFIG_QUICK_SEND_MODE') == 'y':
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861', 'release', 'no_mesh_quick_start'))
        elif scons_utils.scons_usr_bool_option('CONFIG_MESH_SUPPORT') == 'y' and scons_utils.scons_usr_bool_option('CONFIG_MGMT_FRAME_SIZE_1500') == 'y':
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861', 'release', 'mesh_mgmt_size_1500'))
        elif scons_utils.scons_usr_bool_option('CONFIG_MESH_SUPPORT') == 'y':
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861', 'release', 'mesh'))
        elif scons_utils.scons_usr_bool_option('CONFIG_MGMT_FRAME_SIZE_1500') == 'y':
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861', 'release', 'no_mesh_mgmt_size_1500'))
        else:
    ...
    if scons_utils.scons_usr_bool_option('CONFIG_DIAG_SUPPORT') == 'y':
        if factory_mode == 'yes':
        ...
        elif scons_utils.scons_get_cfg_val('CONFIG_CHIP_PKT_48K') == 'y' and scons_utils.scons_usr_bool_option('CONFIG_MESH_SUPPORT') == 'y' and scons_utils.scons_usr_bool_option('CONFIG_MGMT_FRAME_SIZE_1500') == 'y':
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861l', 'debug', 'mesh_pkt_48k_mgmt_size_1500'))
        elif scons_utils.scons_get_cfg_val('CONFIG_CHIP_PKT_48K') == 'y' and scons_utils.scons_usr_bool_option('CONFIG_MESH_SUPPORT') == 'y':
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861l', 'debug', 'mesh_pkt_48k'))
        elif scons_utils.scons_get_cfg_val('CONFIG_CHIP_PKT_48K') == 'y' and scons_utils.scons_usr_bool_option('CONFIG_MGMT_FRAME_SIZE_1500') == 'y':
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861l', 'debug', 'no_mesh_pkt_48k_mgmt_size_1500'))
            ...
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861l', 'debug', 'mesh_mgmt_size_1500'))
        elif scons_utils.scons_usr_bool_option('CONFIG_MESH_SUPPORT') == 'y':
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861l', 'debug', 'mesh'))
        elif scons_utils.scons_usr_bool_option('CONFIG_MGMT_FRAME_SIZE_1500') == 'y':
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861l', 'debug', 'no_mesh_mgmt_size_1500'))
        else:
        ...
        if factory_mode == 'yes':
            ...
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861l', 'release', 'mesh_pkt_48k_mgmt_size_1500'))
        elif scons_utils.scons_get_cfg_val('CONFIG_CHIP_PKT_48K') == 'y' and scons_utils.scons_usr_bool_option('CONFIG_MESH_SUPPORT') == 'y':
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861l', 'release', 'mesh_pkt_48k'))
        elif scons_utils.scons_get_cfg_val('CONFIG_CHIP_PKT_48K') == 'y' and scons_utils.scons_usr_bool_option('CONFIG_MGMT_FRAME_SIZE_1500') == 'y':
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861l', 'release', 'no_mesh_pkt_48k_mgmt_size_1500'))
        elif scons_utils.scons_get_cfg_val('CONFIG_CHIP_PKT_48K') == 'y':
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861l', 'release', 'no_mesh_pkt_48k'))
        elif scons_utils.scons_usr_bool_option('CONFIG_MESH_SUPPORT') == 'y' and scons_utils.scons_usr_bool_option('CONFIG_MGMT_FRAME_SIZE_1500') == 'y':
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861l', 'release', 'mesh_mgmt_size_1500'))
        elif scons_utils.scons_usr_bool_option('CONFIG_MESH_SUPPORT') == 'y':
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861l', 'release', 'mesh'))
        elif scons_utils.scons_usr_bool_option('CONFIG_MGMT_FRAME_SIZE_1500') == 'y':
            env.Append(LIBPATH=os.path.join('-Lbuild', 'libs', 'hi3861l', 'release', 'no_mesh_mgmt_size_1500'))
        else:

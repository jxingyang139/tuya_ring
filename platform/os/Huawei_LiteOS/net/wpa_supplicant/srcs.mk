...
wpa3_ap_srcs =
ifeq ($(CONFIG_WPA3_AP_SUPPORT), y)
    wpa3_ap_srcs += src/ap/pmksa_cache_auth.c
endif
...
ifeq ($(CONFIG_MESH_SUPPORT), y)
    ...
    mesh_wpa3_srcs += src/common/sae.c \
    src/common/dragonfly.c
else ifeq ($(CONFIG_WPA3_AP_SUPPORT), y)
    mesh_wpa3_srcs += src/common/sae.c \
    src/common/dragonfly.c
endif
...
other_srcs = src/rsn_supp/wpa.c \
src/rsn_supp/wpa_ie.c \
src/tls/bignum.c

liteos_wpa_src = liteos_wpa_src/os_rtos.c \
liteos_wpa_src/l2_packet_rtos.c \
liteos_wpa_src/crypto_mbedtls.c \
liteos_wpa_src/wifi_api.c \
liteos_wpa_src/wpa_cli_rtos.c \
liteos_wpa_src/main_rtos.c \
liteos_wpa_src/wifi_mesh_api.c \
liteos_wpa_src/ctrl_iface_rtos.c \
liteos_wpa_src/wifi_softap_api.c \
liteos_wpa_src/hostapd_ctrl_iface_rtos.c \
liteos_wpa_src/hostapd_main_rtos.c
...
driver_hisi = driver_hisi/driver_hisi.c \
driver_hisi/driver_hisi_ioctl.c
...
hostapd_srcs = hostapd/eap_register.c

SRC_FILES = $(ap_srcs) $(mesh_srcs) $(wps_srcs) $(wpa3_srcs) $(wpa3_ap_srcs) $(mesh_wpa3_srcs) $(utils_srcs) $(other_srcs) $(eap_srcs) $(drv_srcs) $(crypto_srcs) $(common_srcs) $(sup_srcs) $(hostapd_srcs) $(liteos_wpa_src) $(driver_hisi)

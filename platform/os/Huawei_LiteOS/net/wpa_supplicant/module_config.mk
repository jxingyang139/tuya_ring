...
CCFLAGS += -I$(MAIN_TOPDIR)/third_party/mbedtls/include \
	...
	-I$(MAIN_TOPDIR)/platform/os/Huawei_LiteOS/net/ltos_src \
	...
	-I$(MAIN_TOPDIR)/platform/os/Huawei_LiteOS/net/wpa_supplicant/liteos_wpa_src \
	-I$(MAIN_TOPDIR)/platform/os/Huawei_LiteOS/net/wpa_supplicant/driver_hisi

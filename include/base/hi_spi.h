...
/**
* @ingroup  iot_spi
* @brief  Set a slave spi to use dma mode.dma mode is invalid for master spi.CNcomment:
*         设置slave 模式下是否使用DMA方式传输数据。master 模式下无效。CNend
*
* @par 描述:
*         Set a slave spi to use dma mode.dma mode is invalid for master spi.CNcomment:
*         设置slave 模式下是否使用DMA方式传输数据。master 模式下无效。CNend
*
* @attention None
* @param  spi_id        [IN] type #hi_spi_idx，SPI ID。
